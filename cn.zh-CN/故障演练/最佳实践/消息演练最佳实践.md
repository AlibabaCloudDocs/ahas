...
您已在机器上安装AHAS探针，具体操作，请参见[快速接入 ECS](/cn.zh-CN/架构感知/接入应用/快速接入 ECS.md)。
...
-   Demo地址：[http://47.110.48.250:8080/](http://47.110.48.250:8080/)
-   开源地址：[https://github.com/cosmic-jc/alibabacloud-microservice-demo](https://github.com/cosmic-jc/alibabacloud-microservice-demo?spm=a2c4g.11186623.2.12.6dd55d429OLEK3)
...
1.  登录[Demo商城](http://47.110.48.250:8080/)，单击一个商品。
...
3.  在消息演练页面，选择**消息组件**，填写相关参数，然后在提示框中单击**确认**。
    ...
    -   **消息组件**：选择**消息组件**为**RocketMQ**，目前仅支持RocketMQ。
...
7.  在演练详情页面，单击**演练**。
    ...
    1.  此时再进入[Demo商城](http://47.110.48.250:8080/)的商品详情页，选择通信方式为**RocketMQ**，单击**添加购物车**，会发现页面没有响应，购物车里无法添加商品，消息演练生效。
