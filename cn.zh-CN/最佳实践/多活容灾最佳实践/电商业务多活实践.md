...
1.  公测阶段，您可以[开通MSHA](/cn.zh-CN/多活容灾/用户指南/开通MSHA.md)为您开通MSHA产品。
...
1.  配置多活空间。
    ...
    7.  单击**+修改**，为每个单元配置相关信息，包含ACM以及接入层集群。然后单击**确定**。
        ...
        ![最佳实践](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/7365911061/p170654.png)
